    ...
    <table width="100%" class="table table-bordered" id="dataTables-example">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align: center"><a href="<?php echo base_url("index.php/c_tampil_peminjaman/view_detail/$h->kode_peminjaman") ?>" data-toggle="tooltip" data-placement="left" title="Pengembalian / Detail"><span class="glyphicon glyphicon-eye-open"></span></a>
          &nbsp;<a href="<?php echo base_url("index.php/c_tampil_peminjaman/perpanjang/$h->kode_peminjaman") ?>" data-toggle="tooltip" data-placement="right" title="Perpanjang"><span class="glyphicon glyphicon-expand"></span></a>
        </tr>
        <?php
        $no=$no+1;
        }
